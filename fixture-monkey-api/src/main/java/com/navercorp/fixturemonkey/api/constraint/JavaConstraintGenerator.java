...
public interface JavaConstraintGenerator {
	...
	@Nullable JavaStringConstraint generateStringConstraint(ArbitraryGeneratorContext context);

	@Nullable JavaIntegerConstraint generateIntegerConstraint(ArbitraryGeneratorContext context);

	@Nullable JavaDecimalConstraint generateDecimalConstraint(ArbitraryGeneratorContext context);

	@Nullable JavaContainerConstraint generateContainerConstraint(ArbitraryGeneratorContext context);

	@Nullable JavaDateTimeConstraint generateDateTimeConstraint(ArbitraryGeneratorContext context);
}
